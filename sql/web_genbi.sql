...
-- Dumping database structure for web_genbi
CREATE DATABASE IF NOT EXISTS `web_genbi` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `web_genbi`;

-- Dumping structure for table web_genbi.alumnis
...
-- Dumping structure for table web_genbi.beritas
...
-- Dumping data for table web_genbi.media: ~0 rows (approximately)

-- Dumping structure for table web_genbi.migrations
...
-- Dumping data for table web_genbi.password_reset_tokens: ~0 rows (approximately)

-- Dumping structure for table web_genbi.personal_access_tokens
...
-- Dumping data for table web_genbi.personal_access_tokens: ~0 rows (approximately)

-- Dumping structure for table web_genbi.users
